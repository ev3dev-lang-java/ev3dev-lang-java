 ...
 */
public class BatteryOld extends EV3DevDevice implements Power {
    ...
    private static BatteryOld instance;
     ...
     * @return Battery
     */
    public static BatteryOld getInstance() {
        //TODO Refactor
        if (instance == null) {
            instance = new BatteryOld();
        }
        return instance;
    }
