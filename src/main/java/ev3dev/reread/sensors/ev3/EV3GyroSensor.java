 ...
 * See {@link SampleProvider leJOS conventions for SampleProviders}
 *
 * @author Andy Shaw
 ...
 * @author David Walend
 */
public class EV3GyroSensor extends BaseSensor implements Closeable {
    ...
    public void close() throws IOException {
        for (SensorMode mode: modes) {
            if(mode instanceof Closeable) ((Closeable)mode).close();
        }
    }
}
