...
//todo eventually differentiate by type sensed - so the Gyro can return a short
public class GenericMode implements SensorMode, Closeable {
    ...
    public GenericMode(
        ...
        for (int n = 0; n < sampleSize; n++) {
            rereaders[n] = new DataChannelRereader(Path.of(this.pathDevice.toString(),"value" + n),32);
        }
    }
