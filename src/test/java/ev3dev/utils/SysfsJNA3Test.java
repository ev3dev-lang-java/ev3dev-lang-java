...
public class SysfsJNA3Test {
    ...
    public void existPathSuccessTest() throws IOException {
        ...
        final boolean result = SysfsJNA3.existPath(fakeBattery.EV3DEV_FAKE_SYSTEM_PATH);
    ...
    public void readString() throws Exception {
        ...
        String result = SysfsJNA3.readString(pathToAssert);
    ...
    public void readInteger() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/" + BATTERY_EV3 + "/" + VOLTAGE;
        int result = SysfsJNA3.readInteger(pathToAssert);
    ...
    public void readFloat() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/" + BATTERY_EV3 + "/" + VOLTAGE;
        float result = SysfsJNA3.readFloat(pathToAssert);
    ...
    public void getElements() throws Exception {
        ...
        assertThat(SysfsJNA3.getElements(pathToAssert), is(fileList));
    }
    ...
    public void existFile() throws Exception {
        ...
        boolean result = SysfsJNA3.existFile(path);
    ...
    public void notExistFile() throws Exception {
        ...
        assertThat(SysfsJNA3.existFile(path), is(false));
    }
    ...
    public void writeString() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/"+ BATTERY_EV3 + "/" + VOLTAGE;
        final Path path = Paths.get(pathToAssert);
        SysfsJNA3.writeString(pathToAssert, "10");

        assertThat(SysfsJNA3.readString(pathToAssert), is("10"));
    }
    ...
    public void readStringWithException() throws Exception {
        ...
        final Path path = Paths.get(pathToAssert);
        SysfsJNA3.readString(pathToAssert);
    }
    ...
    public void writeInteger() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/"+ BATTERY_EV3 + "/" + VOLTAGE;
        final Path path = Paths.get(pathToAssert);
        SysfsJNA3.writeInteger(pathToAssert, 10);

        assertThat(SysfsJNA3.readInteger(pathToAssert), is(10));
    }
    ...
    public void writeBytesTest() {
        ...
        SysfsJNA3.writeBytes(FB_PATH, buf);
    }
