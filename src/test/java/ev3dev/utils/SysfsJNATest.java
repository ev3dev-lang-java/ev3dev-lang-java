...
public class SysfsJNATest {
    ...
    public void existPathSuccessTest() throws IOException {
        ...
        final boolean result = SysfsJNA.existPath(fakeBattery.EV3DEV_FAKE_SYSTEM_PATH);
    ...
    public void readString() throws Exception {
        ...
        String result = SysfsJNA.readString(pathToAssert);
    ...
    public void readInteger() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/" + BATTERY_EV3 + "/" + VOLTAGE;
        int result = SysfsJNA.readInteger(pathToAssert);
    ...
    public void readFloat() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/" + BATTERY_EV3 + "/" + VOLTAGE;
        float result = SysfsJNA.readFloat(pathToAssert);
    ...
    public void getElements() throws Exception {
        ...
        assertThat(SysfsJNA.getElements(pathToAssert), is(fileList));
    }
    ...
    public void existFile() throws Exception {
        ...
        boolean result = SysfsJNA.existFile(path);
    ...
    public void notExistFile() throws Exception {
        ...
        assertThat(SysfsJNA.existFile(path), is(false));
    }
    ...
    public void writeString() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/"+ BATTERY_EV3 + "/" + VOLTAGE;
        final Path path = Paths.get(pathToAssert);
        SysfsJNA.writeString(pathToAssert, "10");

        assertThat(SysfsJNA.readString(pathToAssert), is("10"));
    }
    ...
    public void readStringWithException() throws Exception {
        ...
        final Path path = Paths.get(pathToAssert);
        SysfsJNA.readString(pathToAssert);
    }
    ...
    public void writeInteger() throws Exception {
        ...
        String pathToAssert = FakeBattery.EV3DEV_FAKE_SYSTEM_PATH + "/"+ BATTERY + "/"+ BATTERY_EV3 + "/" + VOLTAGE;
        final Path path = Paths.get(pathToAssert);
        SysfsJNA.writeInteger(pathToAssert, 10);

        assertThat(SysfsJNA.readInteger(pathToAssert), is(10));
    }
    ...
    public void writeBytesTest() {
        ...
        SysfsJNA.writeBytes(FB_PATH, buf);
    }
