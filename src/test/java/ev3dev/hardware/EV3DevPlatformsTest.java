...
public class EV3DevPlatformsTest {
    ...
    public void testEV3BrickSensorPortsTest() throws IOException {
        ...
        assertThat(epc.getSensorPort(SensorPort.S1), is("ev3-ports:in1"));
        assertThat(epc.getSensorPort(SensorPort.S2), is("ev3-ports:in2"));
        assertThat(epc.getSensorPort(SensorPort.S3), is("ev3-ports:in3"));
        assertThat(epc.getSensorPort(SensorPort.S4), is("ev3-ports:in4"));
    }
    ...
    public void testEV3BrickMotorPortsTest() throws IOException {
        ...
        assertThat(epc.getMotorPort(MotorPort.A), is("ev3-ports:outA"));
        assertThat(epc.getMotorPort(MotorPort.B), is("ev3-ports:outB"));
        assertThat(epc.getMotorPort(MotorPort.C), is("ev3-ports:outC"));
        assertThat(epc.getMotorPort(MotorPort.D), is("ev3-ports:outD"));
    }
